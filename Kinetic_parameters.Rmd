...
Y la librería ggplot2 es una de las más usadas para visualizaci´no de datos y
generación de plots.
...
Para que se grafique con una curva de ajuste (línea de tendencia en Excel) se debe
